      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            About InkSpire Support
          </h2>
          <div className="max-w-4xl mx-auto">
            <p className="text-xl text-gray-700 mb-8 leading-relaxed">
              <strong>InkSpire Support</strong> is your trusted technology partner, offering innovative IT, branding, gaming, and digital services to empower individuals and businesses. Based in the heart of Morogoro, we combine local expertise with global technology standards to deliver exceptional results.
            </p>
